...
from oh_memosctl import __version__
from oh_memosctl.init_wizard import run_init_wizard
from oh_memosctl.modes import list_modes, get_mode
from oh_memosctl.service import (
    ServiceStatus,
    check_port_in_use,
    display_status,
    get_service_status,
...
from oh_memosctl.calendar_cmd import run_calendar
...
def status():
    ...
    from oh_memosctl.service import get_service_status, get_mode_status, display_status
