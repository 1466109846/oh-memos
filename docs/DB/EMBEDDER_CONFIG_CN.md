...
使用 [硅基流动 SiliconFlow](https://cloud.siliconflow.cn/i/eaey72Uc) 等云服务托管的嵌入模型，无需本地 GPU。

> 硅基流动提供**免费**的向量模型（BAAI/bge-m3）和重排模型（BAAI/bge-reranker-v2-m3），
> [点击注册](https://cloud.siliconflow.cn/i/eaey72Uc) 即可获取 API Key。
...
| 模型 | 维度 | 后端 | 备注 |
|------|------|------|------|
| BAAI/bge-m3 | 1024 | universal_api | **推荐，多语言，硅基流动免费** |
