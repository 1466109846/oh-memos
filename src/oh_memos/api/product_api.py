...
from oh_memos.api.exceptions import APIExceptionHandler
from oh_memos.api.middleware.request_context import RequestContextMiddleware
from oh_memos.api.routers.product_router import router as product_router
...
if __name__ == "__main__":
    ...
    uvicorn.run("oh_memos.api.product_api:app", host="0.0.0.0", port=args.port, workers=args.workers)
