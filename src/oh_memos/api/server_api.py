...
from oh_memos.api.routers.server_router import router as server_router
...
if __name__ == "__main__":
    ...
    uvicorn.run("oh_memos.api.server_api:app", host="0.0.0.0", port=args.port, workers=args.workers)
