...
from oh_memos.mem_reader.read_multi_modal.utils import detect_lang, parse_json_result
...
from oh_memos.templates.cloud_service_prompt import get_cloud_chat_prompt
