...
from oh_memos.templates.mem_reader_prompts import IMAGE_ANALYSIS_PROMPT_EN, IMAGE_ANALYSIS_PROMPT_ZH
from oh_memos.types.openai_chat_completion_types import ChatCompletionContentPartImageParam
