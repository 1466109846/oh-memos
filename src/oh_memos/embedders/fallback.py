...
from oh_memos.configs.embedder import FallbackConfig, OllamaEmbedderConfig
from oh_memos.embedders.base import BaseEmbedder
from oh_memos.exceptions import (
    EmbedderError,
...
if TYPE_CHECKING:
    from oh_memos.configs.embedder import BaseEmbedderConfig
