...
from oh_memos.configs.vec_db import QdrantVecDBConfig
from oh_memos.dependency import require_python_package
from oh_memos.log import get_logger
from oh_memos.vec_dbs.base import BaseVecDB
...
class QdrantVecDB(BaseVecDB):
    ...
    def __init__(self, config: QdrantVecDBConfig):
        ...
        self.client = QdrantClient(**client_kwargs, check_compatibility=False)
