...
from oh_memos.mem_scheduler.orm_modules.base_model import DatabaseError
...
class APIRedisDBManager:
    ...
    def merge_items(
        ...
        from oh_memos.mem_scheduler.schemas.api_schemas import APIMemoryHistoryEntryItem
