...
from oh_memos.memories.activation.item import ActivationMemoryItem
from oh_memos.memories.parametric.item import ParametricMemoryItem
from oh_memos.memories.textual.item import TextualMemoryItem, TextualMemoryMetadata
from oh_memos.memos_tools.thread_safe_dict_segment import OptimizedThreadSafeDict
from oh_memos.templates.mos_prompts import QUERY_REWRITING_PROMPT
        ...
        if mem_cube_id in self.mem_cubes:
            ...
            if isinstance(mem_cube_name_or_path, GeneralMemCube):
                ...
                if actual_path:
                    ...
                    mem_cube_obj = GeneralMemCube.init_from_dir(actual_path)
