...
from oh_memos.graph_dbs.factory import GraphStoreFactory, Neo4jGraphDB
...
from oh_memos.memories.textual.tree_text_memory.retrieve.advanced_searcher import (
    ...
    def load(self, dir: str) -> None:
        try:
            ...
            if not os.path.exists(memory_file):
                logger.info(f"Memory file not found: {memory_file}")
                return
